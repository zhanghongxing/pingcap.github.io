        ...
        function isRecyclable(old, vnodes) {
          if (
            ...
            var vnodesChildrenLength =
              (vnodes[0] && vnodes[0].children && vnodes[0].children.length) ||
              0
            if (
        ...
        function updateEvent(vnode, key2, value) {
          ...
          if (key2 in element)
            ...
            if (vnode.events[key2] != null)
              element.removeEventListener(eventName, vnode.events[key2], false)
              ...
              if (matcher.test(pathname)) {
                pathname.replace(matcher, function() {
                  ...
                  for (var i = 0; i < keys.length; i++) {
                    params[keys[i].replace(/:|\./g, '')] = decodeURIComponent(
                      values[i]
                    )
                  }
